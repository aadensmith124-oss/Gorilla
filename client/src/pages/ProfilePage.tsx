    ...
    <Card className="bg-card border-border">
      ...
      <CardContent className="space-y-3">
        {isLinked ? (
          ...
          <p className="text-sm text-muted-foreground">Link your Telegram to earn <strong className="text-primary">$1.00 daily</strong> just by having <code className="text-xs bg-white/8 px-1 py-0.5 rounded">unitedcards.cc</code> in your name.</p>
        )}
